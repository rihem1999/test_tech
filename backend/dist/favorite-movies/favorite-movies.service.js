...
exports.FavoriteMoviesService = void 0;
const common_1 = require("@nestjs/common");
const typeorm_1 = require("@nestjs/typeorm");
const typeorm_2 = require("typeorm");
const favourite_movie_entity_1 = require("./favourite-movie.entity");
let FavoriteMoviesService = class FavoriteMoviesService {
    constructor(favoriteMoviesRepository) {
    ...
    async update(id, updateFavoriteMovieDto) {
...
exports.FavoriteMoviesService = FavoriteMoviesService;
exports.FavoriteMoviesService = FavoriteMoviesService = __decorate([
    (0, common_1.Injectable)(),
    __param(0, (0, typeorm_1.InjectRepository)(favourite_movie_entity_1.FavoriteMovie)),
    __metadata("design:paramtypes", [typeorm_2.Repository])
], FavoriteMoviesService);
//# sourceMappingURL=favorite-movies.service.js.map